...
class analisa extends MY_Controller {
    ...
    {
		$data['analisa']      = $this->Mod_analisa->getAll();
        ...
        if($this->uri->segment(3)=="create-success") {
            ...
            $this->template->load('layoutbackend', 'analisa/analisa_data', $data); 
        }
    ...
    {
        $this->template->load('layoutbackend', 'analisa/analisa_create');
    }
